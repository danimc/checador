...
class D_test extends CI_Controller {
...
$pdf->SetSubject('Detalle de Asistencias');
...
for ($x=0; $x < count($datos) ; $x++) {
    ...
    $rows = $rows . '<tr><td>' . $datos[$x]->nombre . '</td><td>'.$datos[$x]->entrada_normal.'</td><td>'.$datos[$x]->entrada_retardo.'</td><td>'.$datos[$x]->entrada_falta.'</td><td>'.$datos[$x]->salida_normal.'</td><td>'.$datos[$x]->salida_anticipada.'</td></tr>';
...
<table border="0">
    <tr>
        ...
        <th align="center" width="50%">
            <span style="font-size: large;">DETALLE DE ASISTENCIAS</span>
            <BR>
...
EOD;
            ...
            // This method has several options, check the source code documentation for more information.
            $pdf->Output('Detalle de Asistencias.pdf', 'I');
