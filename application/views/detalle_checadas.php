...
<head>
<meta charset="utf-8"/>
<title>Detalle de Checadas</title>
					...
					<div class="portlet light">
							<div class="portlet-title tabbable-line">				
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject uppercase"> Detalle de Checadas </span></h2>
							...
							<div class="col-md-12" ng-show="datos.length > 0">
				            	<div class="portlet box green" style="background-color: #5B6871!important; border-color:#5B6871">
				            	   <div class="portlet-title" style="background-color: #5B6871!important; border-color:#5B6871">
								       <div class="caption">
								           <i class="fa fa-comments"></i>Detalle de las Checadas 
								       </div>
								   </div>
...
<!-- 	<script src="<?= base_url(); ?>assets/js/jquery-ui/jquery-ui.min.js" type="text/javascript"></script> -->
	...
	<!-- END CORE PLUGINS -->
 	...
 	<script src="<?= base_url(); ?>assets/js/scripts/detalle_checada.js" type="text/javascript"></script>
