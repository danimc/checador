...
<head>
<meta charset="utf-8"/>
<title>Justificaciones por Empleado</title>
								...
								<div class="portlet light">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject uppercase"> Justificaciones Empleado </span></h2>
                                            <span class="caption-helper">Justificación de Checadas a un Empleado...</span>
                                        </div>
                            		...
                            		<div class="form-group col-md-12">
										<div class="col-md-12">
											<label class="lead">Nombre, Fecha y Tipo a Justificar</label>
										</div>
										...
										<div class="form-group col-md-5">
											<label class="lead col-md-12">Fecha y Tipo</label>
												<div class="col-md-6">
...
<!-- 	<script src="<?= base_url(); ?>assets/js/jquery-ui/jquery-ui.min.js" type="text/javascript"></script> -->
	...
	<!-- END CORE PLUGINS -->
 	...
 	<script src="<?= base_url(); ?>assets/js/scripts/justifica_empleado.js" type="text/javascript"></script>
