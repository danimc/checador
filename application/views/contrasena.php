...
<head>
<meta charset="utf-8"/>
<title>Contraseña Empleado</title>
					...
					<div class="col-md-6"> -->
								...
								<div class="typeahead-container">
						            ...
						            <span class="typeahead-query">
						                <input id="nombre"
						                       ...
						                       autofocus
						                       autocomplete="off"
						                       class="form-control input-large grandes valida ng-pristine ng-valid ng-valid-maxlength ng-touched">
						            </span>
						...
						<div class="form-group">
							<label class="lead">Contraseña</label>
								<div class="input-group">
									<input maxlength="8" type="password" placeholder="Contraseña Empleado" id="contrasena" class="form-control input-large grandes valida ng-pristine ng-valid ng-valid-maxlength ng-touched">
								</div>
						</div>
						<button id="cambios" class="btn green-haze btn-lg btn-block disabled"><h2>Guardar Contraseña</h2></button>
					 </div>
...
<![endif]-->
	...
	<script src="<?= base_url(); ?>assets/js/scripts/contrasena.js" type="text/javascript"></script>
