								...
								<div class="portlet light">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject uppercase"> Días Económicos </span></h2>
                                            <span class="caption-helper">Días Económicos por Empleado...</span>
                                        </div>
                            		...
                            		<div class="form-group col-md-12">
										<div class="col-md-12">
											<label class="lead">Nombre y Fecha para el Económico</label>
										</div>
										...
										<div class="form-group col-md-5">
											<label class="lead col-md-12">Fecha</label>
												<div class="col-md-6">
										...
										<div>
											...
											<div class="col-md-2">
												<button id="economico" class="btn green-haze">Agregar Económico</button> 
											</div>
...
<!-- 	<script src="<?= base_url(); ?>assets/js/jquery-ui/jquery-ui.min.js" type="text/javascript"></script> -->
	...
	<!-- END CORE PLUGINS -->
 	...
 	<script src="<?= base_url(); ?>assets/js/scripts/economico.js" type="text/javascript"></script>
