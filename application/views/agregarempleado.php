...
<!-- 					<div class="col-md-6"><video id="video" class="col-md-12" autoplay></video></div>
					<div class="col-md-6"> -->
					<div class="col-md-12">
						<center><h2>Registro de Nuevo Empleado</h2></center>
					</div>

						<div class="row">
							<div class="form-group col-md-12">
								<label class="lead">Nombre de empleado</label>
									<div>
										<input type="text" placeholder="Nombre Empleado" id="nombre" class="form-control valida ng-pristine ng-valid ng-valid-maxlength ng-touched input-xlarge">
									</div>
							</div>
						</div>	
						<div class="row">	
						...
						<div class="form-group col-md-12 row">																			
							<button id="agregaremp" class="btn green-haze btn-lg btn-block" style="width:50%">Agregar</button>
						</div>
					 </div>
...
<![endif]-->
	...
	<script src="<?= base_url(); ?>assets/js/scripts/jsagregaemp.js" type="text/javascript"></script>
