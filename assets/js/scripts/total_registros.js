    ...
    angular.module('MyApp',[])
        .controller("AppCtrl", function ($scope, $http) {
            ...
            if($("#fechainicial").val() && $("#fechafinal").val() ){
                ...
                var req = {
                    method: 'GET',
                    url: 'consulta/traer_total_registros?fechainicial='+ $("#fechainicial").val()+'&fechafinal='+ $("#fechafinal").val()
                };
                $http(req)
    ...
    document.getElementById("print_detalle").addEventListener("click", function() {
            ...
            if($("#fechainicial").val() && $("#fechafinal").val() ){
               window.open("imprimir_total_registros?fechainicial="+ $("#fechainicial").val()+"&fechafinal="+ $("#fechafinal").val());  
            } else{
               sweetAlert("Oops...", "Debes de llenar todos los datos para el reporte", "warning"); 
            }
